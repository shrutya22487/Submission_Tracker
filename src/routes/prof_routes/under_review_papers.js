...
// adding project
router.post('/add_paper', check_authentication, async (req, res) => {
...
`, [prof_id]);
    ...
    res.render("under_review_papers_prof.ejs", {prof_name : prof_name,project_details_unarchived : project_details_unarchived,
